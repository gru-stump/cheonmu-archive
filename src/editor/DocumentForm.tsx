...
type DocumentFormProps = { value: DocumentMeta; errors: Record<string, string>; idEditable: boolean; disabled?: boolean; onChange(next: Partial<DocumentMeta>): void; onBodyChange(value: string): void; body: string };
...
export function DocumentForm({ value, errors, idEditable, disabled = false, onChange, onBodyChange, body }: DocumentFormProps): JSX.Element {
  const prefix = useId();
  ...
  return <fieldset disabled={disabled}><legend>문서 정보</legend>
