...
values ('10000000-0000-0000-0000-000000000001', 'Local narrative owner')
on conflict (owner_id) do update set display_name = excluded.display_name;

insert into public.provider_settings (owner_id, provider_key, enabled, configuration)
values (
  '10000000-0000-0000-0000-000000000001',
  'fake-local-provider',
  false,
...
values
  ('10000000-0000-0000-0000-000000000001', 'daily-local-fixture', '0 9 * * *', false, '{}'::jsonb),
  ('10000000-0000-0000-0000-000000000001', 'weekly-local-fixture', '0 9 * * 1', false, '{}'::jsonb)
