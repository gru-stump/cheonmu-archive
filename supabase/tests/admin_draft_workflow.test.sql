...
insert into public.draft_versions (id, owner_id, draft_id, version_number, content, context_version_ids, continuity_level, continuity_policy_version) values
  ('a2000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 1, '{"title":"editable","body":"선택 구절","canonChangeCandidates":[]}', array['canon-v7'], 'review', 'cheonmu-continuity-v1'),
  ('a2000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000002', 1, '{"title":"blocked","body":"blocked","canonChangeCandidates":[]}', array['canon-v7'], 'block', 'cheonmu-continuity-v1'),
  ('a2000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000003', 1, '{"title":"revise","body":"선택 구절 뒤의 본문","canonChangeCandidates":[]}', array['canon-v7'], 'review', 'cheonmu-continuity-v1'),
  ('a2000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000004', 1, '{"title":"archive","body":"archive body","canonChangeCandidates":[]}', array['canon-v7'], 'review', 'cheonmu-continuity-v1'),
  ('a2000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 1, '{"title":"retry","body":"retry body","canonChangeCandidates":[]}', array['canon-v7'], 'review', 'cheonmu-continuity-v1');
update public.drafts set status = 'reviewing' where id in ('a1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003');
