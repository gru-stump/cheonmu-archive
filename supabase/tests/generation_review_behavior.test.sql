...
values
  ('82000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '81000000-0000-0000-0000-000000000001', 1, '{"body":"reject body"}'),
  ('82000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '81000000-0000-0000-0000-000000000002', 1, '{"body":"private body"}'),
  ('82000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', '81000000-0000-0000-0000-000000000003', 1, '{"body":"public body"}');
...
select lives_ok(
  $$ select public.review_draft_atomic('81000000-0000-0000-0000-000000000001', '82000000-0000-0000-0000-000000000001', 'reviewing', 'reject', '인물이 맞지 않음', 'reject-once') $$,
...
select throws_ok(
  $$ select public.review_draft_atomic('81000000-0000-0000-0000-000000000001', '82000000-0000-0000-0000-000000000001', 'reviewing', 'reject', 'duplicate', 'reject-once') $$,
  'P0001', 'duplicate_review', 'a duplicate review action returns a conflict signal'
);

select lives_ok(
  $$ select public.review_draft_atomic('81000000-0000-0000-0000-000000000002', '82000000-0000-0000-0000-000000000002', 'reviewing', 'approve_private', null, 'private-once') $$,
...
select lives_ok(
  $$ select public.review_draft_atomic('81000000-0000-0000-0000-000000000003', '82000000-0000-0000-0000-000000000003', 'reviewing', 'approve_public', null, 'public-once') $$,
...
select throws_ok(
  $$ select public.review_draft_atomic('81000000-0000-0000-0000-000000000003', '82000000-0000-0000-0000-000000000003', 'reviewing', 'approve_public', null, 'public-stale') $$,
