...
values
  ('a2000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'hardening-major', '2026-08-14T01:00:00Z'),
  ('a2000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000002', 'hardening-failure', '2026-08-14T02:00:00Z'),
  ('a2000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000002', 'hardening-retry', '2026-08-14T03:00:00Z');
...
select is((select public.reserve_and_start_generation('a2000000-0000-0000-0000-000000000001', 100) ->> 'status'), 'reserved', 'retry can reserve and start');
select throws_ok(
  $$ select public.finalize_generation_success(
    'a2000000-0000-0000-0000-000000000001', 1, '{"inputTokens":14,"outputTokens":10,"costMicros":1}',
...
select lives_ok(
  $$ select public.finalize_generation_success(
    'a2000000-0000-0000-0000-000000000001', 100, '{"inputTokens":14,"outputTokens":10,"costMicros":1}',
    '{"kind":"major_event_proposal","title":"scene plan","body":"private result"}',
