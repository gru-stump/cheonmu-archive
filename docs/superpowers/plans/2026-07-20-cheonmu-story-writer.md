...
└─ references/style-samples/guide.md

.superpowers/sdd/cheonmu-story-writer/
...
**Files:**
- Create: `.superpowers/sdd/cheonmu-story-writer/scenarios.md`
- Create: `.superpowers/sdd/cheonmu-story-writer/baseline.md`
...
```powershell
git add -f .superpowers/sdd/cheonmu-story-writer/scenarios.md .superpowers/sdd/cheonmu-story-writer/baseline.md
...
- Create: `.agents/skills/cheonmu-story-writer/references/style-samples/guide.md`
...
**Files:**
- Create: `.superpowers/sdd/cheonmu-story-writer/results.md`
...
```powershell
git add .agents/skills/cheonmu-story-writer
git add -f .superpowers/sdd/cheonmu-story-writer/results.md
