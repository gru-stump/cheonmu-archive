...
describe('NarrativeApi', () => {
  ...
  it('sends immutable-version and focused-revision concurrency fields', async () => {
    ...
    await api.generate({ draftId: 'd1', expectedVersionId: 'v3', mode: 'revise_selection', kind: 'short_dialogue', revision: { selectedText: '선택', instruction: '수정' }, requestedMaxOutputTokens: 128, maximumCostConfirmed: true, confirmedMaximumCostMicros: 321 });
